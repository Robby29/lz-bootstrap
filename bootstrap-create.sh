...
#Network
gcloud compute networks create lz-network --subnet-mode=custom
gcloud compute networks subnets create lz-subnet-$region --network=lz-network --region=$region --range=10.160.0.0/24
